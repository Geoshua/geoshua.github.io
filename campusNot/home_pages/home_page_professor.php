<?php 
    include("../security_protocols/professor_check_security.php");
?>
...
<html>
    ...
    <body>
        ...
        <div class="content-grid-container">
            <div class="content-grid-item">Not Important</div>
            <div class="content-grid-item">Not Important</div>
            <div class="content-grid-item">Not Important</div>  
            <div class="content-grid-item-imp">Important</div>
            <div class="content-grid-item">Not Important</div>
            <div class="content-grid-item">Not Important</div>  
            <div class="content-grid-item-impX">Important!!!</div>
            <div class="content-grid-item-imp">Important</div>
            <div class="content-grid-item">Not Important</div>  
        </div>
    </body>
